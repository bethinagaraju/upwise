...
// // //                 <span className="text-lg">98916 28225</span>
// // //               </div>
// // //               <div className="flex items-center space-x-4">
...
//     if (!authorizeContact) {
//       alert("Please authorize contact to continue.");
//       return;
//     }

//     emailjs
//       .send(
//         "service_fia16gg",         // ✅ Your SERVICE ID
//         "template_yhe3e2n",        // ✅ Your TEMPLATE ID
//         {
//           from_name: formData.name,
//           from_email: formData.email,
//           mobile: formData.mobile
//         },
//         "RjaBjLzRhs3dZdy6q"        // ✅ Your PUBLIC KEY
//       )
//       .then(() => {
...
//   return (
//     <section className="py-20 bg-[#FDB813] flex items-center justify-center min-h-screen">
...
//             <button
//               type="submit"
//               className="w-full bg-blue-700 text-white px-6 py-3 rounded-md font-bold text-lg"
//             >
//               Schedule A Meeting
//             </button>
//           </form>
