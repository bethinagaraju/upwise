          ...
          <nav className="hidden md:flex items-center">
            <ul className="flex space-x-12 relative">
              ...
              <li className="relative group">
                ...
                {/* Dropdown */}
                <div className="absolute left-0 w-40 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition opacity duration-200">
                  <ul className="py-2">
                    <li>
                      <a
                        href="/ignite"
