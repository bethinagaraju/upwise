...
//         "text-zinc-900 px-6 py-12 md:px-10 lg:py-24 lg:px-12 min-h-screen"
//       )}
//       style={{
//         background: "radial-gradient(circle at center, #ffffffff, #f8976334)",
//       }}
...
//           <span
//             key={i}
//             className={`absolute opacity-25 sm:opacity-40 transition-transform duration-500 ${item.className}`}
//             style={{ zIndex: 1 }}
//             aria-hidden="true"
//           >
//             {item.svg}
...
//         <div className="flex justify-center mb-6">
//           <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-full flex items-center space-x-3">
//             <Flame className="w-10 h-10" />
//             <span className="text-4xl font-bold">IGNITE</span>
//           </div>
//         </div>

//         <TextStagger
//           text="Master Microsoft Office,"
//           className="font-times-new-roman text-5xl sm:text-6xl font-bold tracking-tight text-[#f89763]"
//         />
...
//           <p className="text-xl md:text-2xl font-semibold text-[#4a4a4a]">
//             For the Future-Ready Workplace
//           </p>
//         </AnimatedContainer>

//         <AnimatedContainer className="mt-2">
//           <p className="text-lg text-[#4a4a4a] font-medium">
//             By{" "}
//             <strong className="text-[#f89763] font-bold">Ritu Arora</strong> –{" "}
//             <span>Microsoft Specialist | AI Trainer | Corporate Coach</span>
//           </p>
//         </AnimatedContainer>

//         <AnimatedContainer className="mt-10 flex flex-wrap gap-4 justify-center">
...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full text-center px-2">
        <div className="flex justify-center mb-6">
          <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-3 sm:px-6 sm:py-4 rounded-full flex items-center space-x-4">
            ...
            <span className="text-3xl sm:text-4xl font-bold">IGNITE</span>
          </div>
        </div>
        ...
        <AnimatedContainer className="mt-2 sm:mt-3">
      ...
      {/* Hero Image */}
      <img
        src="Gemini_Generated_Image_xvx7hxvx7hxvx7hx-removebg-preview.png"
        onError={(e) => {
          e.currentTarget.src =
            "https://placehold.co/600x800/CCCCCC/FFFFFF?text=Image+Not+Found"
          e.currentTarget.onerror = null
        ...
        alt="Ritu Arora"
        className="absolute bottom-0 right-0 w-[80%] max-h-[25vh] right-[-80px]
