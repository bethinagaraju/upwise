...
export default function ElevateHero() {
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full text-center px-2">
        <div className="flex justify-center mb-6">
          <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-3 sm:px-6 sm:py-4 rounded-full flex items-center space-x-4">
            ...
            <Scale className="w-8 h-8 sm:w-12 sm:h-12" />
            <span className="text-3xl sm:text-4xl font-bold">EMPOWER</span>
          </div>
        </div>

        <TextStagger
          text="Workplace Safety Legal Awareness"
        ...
        <AnimatedContainer className="mt-4 sm:mt-6">
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-[#4a4a4a]">
            A flagship program on POSH and workplace conduct.
          </p>
        </AnimatedContainer>
        ...
        <AnimatedContainer className="mt-2 sm:mt-3 lg:mr-10">
          <p className="text-sm sm:text-base md:text-lg text-[#4a4a4a] font-medium leading-snug">
            By{" "}
            <strong className="text-[#f89763] font-bold">Dr.Sanya Talwar</strong> –{" "}
            <span className="text-xs sm:text-sm md:text-base">Supreme Court Lawyer | Gender Rights advocate | POSH Enabler</span>
          </p>
        </AnimatedContainer>
      ...
      {/* Hero Image */}
      <img
        src="Flux_Dev_prompt_A_young_woman_appearing_below_26_years_old_wit_0-removebg-preview.png"
        onError={(e) => {
          e.currentTarget.src =
