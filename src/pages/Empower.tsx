...
import EmpowerHero from '../components/EmpowerHero';
import EmpowerAbout from '../components/EmpowerAbout';
import EmpowerEssentialsCard from '../components/EmpowerEssentialsCard';
import EmpowerTrainer from '../components/EmpowerTrainer';
